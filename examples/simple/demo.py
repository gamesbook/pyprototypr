...
Trapezoid(cx=16, cy=17, width=4, width2=3, height=3, label="trapezoid:16-17", common=dot)
...
Trapezoid(cx=16, cy=17, width=4, width2=3, height=3, heading="trapezoid:16-17", common=dot)
...
Trapezoid(cx=16, cy=17, width=4, width2=3, height=3, title="trapezoid:16-17", common=dot)
...
Trapezoid(cx=16, cy=15, width=4, width2=3, height=3, rotation=45, stroke_width=2, label="Trapezoid")
