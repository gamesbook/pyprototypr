...
Hexagon(common=hxg, x=0.25, y=2.15, radii='n', label="N")
Hexagon(common=hxg, x=0.25, y=4, radii='nw', label="NW")
Hexagon(common=hxg, x=2.25, y=4, radii='ne', label="NE")
Hexagon(common=hxg, x=2.25, y=2.15, radii='s', label="S")
...
Hexagon(common=hxg, x=0.25, y=4, radii='e', label="E")
Hexagon(common=hxg, x=2.25, y=4, radii='ne', label="NE")
Hexagon(common=hxg, x=2.25, y=0.25, radii='w', label="W")
