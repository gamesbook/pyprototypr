...
Repeat(oct_flat, cols=8, rows=8, across=(1, 3, 5, 7), down=(1, 3, 5, 7), gap=2.2, offset_x=2.2)
Repeat(oct_vert, cols=8, rows=8, across=(1, 3, 5, 7), down=(1, 3, 5, 7), gap=2.2)
Repeat(oct_vert, cols=8, rows=8, across=(2, 4, 6, 8), down=(2, 4, 6, 8), gap=2.2, offset_x=0)
Repeat(oct_flat, cols=8, rows=8, across=(2, 4, 6, 8), down=(2, 4, 6, 8), gap=2.2, offset_x=-2.2)
