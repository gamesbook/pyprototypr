...
Notes:
    uses `bgg-api` Python library (https://github.com/SukiCZ/boardgamegeek)
"""
...
games = BGG(ids=choice, progress=True, short=600)  # short: number of characters
...
for item in choice:
    desc = text(font_face="Times New Roman", font_size=9, stroke="#808080",
